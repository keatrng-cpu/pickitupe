...
export const FAQ: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "Most city lots land between $160 and $345 depending on square footage — about $32–$46 per 1,000 sq ft on the first 8,000. Half acre and acreage drop per foot but still clear a full-day rate. You get a range on this page before you book, and we confirm the number before any work starts.",
  },
  {
