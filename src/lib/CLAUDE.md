...
| File | Job |
|---|---|
| `pricebook.ts` | **Only place money numbers live.** Promo is Oct 10 (extended from the printed Sept 20) / 20% / $75 cap, not a "first 25" count. Recalibrate via `PRICEBOOK.md`. |
